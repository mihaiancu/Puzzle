...
\lean{Z2}
\leanok
$\Zz^n := \Zz\times...\times\Zz$. $\Zz^n$ can be seen as the set of all functions from $\Fin n$ to $\Zz$. We consider $\Zz^n$ as a \href{https://leanprover-community.github.io/mathlib4_docs/Mathlib/Algebra/Module/Defs.html#Module}{module} over $\Zz$.
\end{definition}
